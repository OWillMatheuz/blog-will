                ...
                <Grid alignItems="center" item xs={12}>
                    <Box style={{ backgroundColor: "#3F51B5", height: "120px" }}>
                        <Box paddingTop={1} display="flex" alignItems="center" justifyContent="center">
                            <Typography variant="h5" align="center" gutterBottom style={{ color: "white" }}>Siga-me os bons: </Typography>
                        </Box>
                    ...
                    <Box style={{ backgroundColor: "#303F9F", height: "60px" }}>
                        ...
                        <Box>
                            <a target="_blank" href="https://github.com/OWillMatheuz">
                                <Typography variant="subtitle2" gutterBottom style={{ color: "white" }} align="center">github.com/OWillMatheuz</Typography>
                            </a>
                        </Box>
                    </Box>
                </Grid>
